...
const SignUp = ({setIsLogin, setValidationErrors}: SignUp_type) => {
    ...
    return (
        <form className="authentication__form signup__form" onSubmit={(e) => createUser(e)}>
            <div className="email_container form__section-container">
            ...
            <div className="name_container form__section-container">
                <label htmlFor="username" className="authentication__label">Usuario</label>
                <div className="form__section-container">
            ...
            <div className={`password__container ${!passwordsMatch && 'no-match'}`}>
                <label htmlFor="re-pwd" className="authentication__label">Confirmar contraseña</label>
                <div className="form__section-container">
